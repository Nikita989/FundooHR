...
class BankDataServices: NSObject {
    ...
    func updateBankData(bankData:BankDataModel)
    {
        ...
        let params = ["token":"1a285sdffd8do8fd","engineerId":(engineerId),"accountNumber": (bankData.mAccNumber), "bankName" : (bankData.mBankName),"ifscCode":(bankData.mBankIfscCode),"pan":(bankData.mBankPan),"paySalary":(bankData.mBankPaySalary),"reason":(bankData.mReason)]
