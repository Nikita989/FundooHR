...
class personalDataServices: NSObject {
    ...
    func fetchPersonalDataFromDatabase()
    {
        ...
        Alamofire.request("\(mUrlString)/readEmployeePersonalData?token=fghf&engineerId=\(engineerId)").responseJSON
        { response in
